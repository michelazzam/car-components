...
import { DraftInvoice, usePosStore } from "@/shared/store/usePosStore";
  ...
  return (
    <div>
      ...
      <ConfirmModal
        ...
        onConfirm={() => {
          // handleDelete(d.draft_invoice_id, d.isCurrent);
          if (selectedDraft) {
            handleDelete(
              selectedDraft?.draft_invoice_id,
